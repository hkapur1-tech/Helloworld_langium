...
- [src/hello-world.langium](src/hello-world.langium) -  The grammar definition of your language
- [src/hello-world-module.ts](src/hello-world-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/hello-world-validator.ts](src/hello-world-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/hello-world.monarch.ts](src/syntaxes/hello-world.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/hello-world.tmLanguage.json](syntaxes/hello-world.tmLanguage.json) - Textmate based syntax highlighting instructions.
